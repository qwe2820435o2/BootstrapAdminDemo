    ...
    public int doStartTag() throws JspException {
        ...
        try {
        	...
        	if (page.getPage() > 1) {
                ...
                if (page.getPage()-2 > 1) {
                    String firstUrl = append(url, "page", 1);
                    writer.print(String.format("<li><a href='%s'>首页</a></li>", firstUrl));
                }
            ...
            if (page.getPage() < pageCount) {
				...
				if (page.getPage()+2 < pageCount) {
					String lastUrl  = append(url, "page", pageCount);
                    writer.print("<li><a href='" + lastUrl + "'>尾页</a></li>");
                }
